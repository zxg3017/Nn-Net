...
from models.my_H_Net_model.H_Net import H_Net_resnet50_RNet

parser = argparse.ArgumentParser(description='my semi-supervised learning')
parser.add_argument('--imgs_test_path', '-iv', type=str, default='/mnt/ai2019/zxg_FZU/dataset/skin_lesion_data/seg/test/Images/', help='imgs val data path.')
parser.add_argument('--labels_test_path', '-lv', type=str, default='/mnt/ai2019/zxg_FZU/dataset/skin_lesion_data/seg/test/Annotation/', help='labels val data path.')
...
result_path='/mnt/ai2019/zxg_FZU/dataset/H_Net_result/skin_lesion/resnet/skin_H_Net_resnet50_RNet/'
result_roc_path='/mnt/ai2019/zxg_FZU/dataset/H_Net_result/skin_lesion/resnet/skin_H_Net_resnet50_RNet_roc/'
...
net = H_Net_resnet50_RNet(3,2)

net.load_state_dict(torch.load('/mnt/ai2019/zxg_FZU/seg_and_cls_projects/my_secode_paper_source_code/checkpoint/H_Net/skin_lesion/resnet/skin_H_Net_resnet50_RNet.pth')['net'], strict=True)
