...
class MyDataSet_seg(data.Dataset):
    def __init__(self, root_path, list_path, root_path_csv=None, crop_size=(crop_h,crop_w), max_iters=None):
    ...
    def __getitem__(self, index):
        ...
        # coarsemask = Image.open(self.root_path_csv + datafiles["img"][7::])
        ...
        coarsemask = Image.open(self.root_path_csv + datafiles["img"][7:-4] + '.png')
...
class MyValDataSet_seg(data.Dataset):
    def __init__(self, root_path, list_path, root_path_coarsemask=None, crop_size=(crop_w, crop_w)):
        self.root_path = root_path
...
class MyTestDataSet_seg(data.Dataset):
    def __init__(self, root_path, list_path, root_path_coarsemask=None, crop_size=(crop_w, crop_h)):
        self.root_path = root_path
        self.root_path_coarsemask = root_path_coarsemask
        self.list_path = list_path
        self.crop_h, self.crop_w = crop_size
...
class MyGenDataSet(data.Dataset):
    def __init__(self, root_path, list_path, mode=0, crop_size=(crop_h, crop_h)):
        self.root_path = root_path
        self.list_path = list_path
        self.mode = mode
        self.crop_h, self.crop_w = crop_size
...
class MyDataSet_cls(data.Dataset):
    def __init__(self, root_path, root_path_coarsemask, list_path, max_iters=None, crop_size=(crop_h, crop_h)):
        self.root_path = root_path
        self.root_path_coarsemask = root_path_coarsemask
        self.list_path = list_path
        self.crop_h, self.crop_w = crop_size
...
class MyValDataSet_cls(data.Dataset):
    def __init__(self, root_path, root_path_coarsemask, list_path, crop_size=(crop_h, crop_h)):
        self.root_path = root_path
        self.root_path_coarsemask = root_path_coarsemask
        self.list_path = list_path
        self.crop_h, self.crop_w = crop_size
